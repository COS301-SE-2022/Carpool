...
let AppController = class AppController {
    ...
    create(request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                yield this.appService.fileupload(request, response);
            }
            catch (error) {
                return response
                    .status(500)
    ...
    getImage(request, response, params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                yield this.appService.getImage(request, response, params);
            }
            catch (error) {
                return response
                    .status(500)
...
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const S3 = __webpack_require__("aws-sdk/clients/s3");
const multer = __webpack_require__("multer");
const multerS3 = __webpack_require__("multer-s3");
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object, Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppService.prototype, "getImage", null);
tslib_1.__decorate([
    tslib_1.__param(0, (0, common_1.Req)()),
    tslib_1.__param(1, (0, common_1.Res)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppService.prototype, "fileupload", null);
...
AuthenticationModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            service_2.AdminLoginHandler,
            service_4.TripsService,
            service_2.UpdateUserImageHandler,
...
let AuthResolver = class AuthResolver {
    ...
    updateUserImage(id, image) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.authService.updateUserImage(id, image);
        });
    }
    findUserById(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    adminLogin(email, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const userObj = yield this.authService.adminLogin(email, password);
            if (userObj) {
                const user = new entities_1.AdminUserReturn();
                user.id = userObj.id;
                user.email = userObj.email;
    ...
    registerDriver(ID, licensePlate, carModel, userId, license) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const driverObj = yield this.authService.registerDriver(userId, licensePlate, carModel, ID, license);
            if (driverObj) {
                return driverObj;
            }
            else {
...
tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, graphql_1.Args)('image')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, String]),
    tslib_1.__metadata("design:returntype", typeof (_k = typeof Promise !== "undefined" && Promise) === "function" ? _k : Object)
], AuthResolver.prototype, "updateUserImage", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    (0, graphql_1.Query)(() => entities_1.AdminUserReturn),
    tslib_1.__param(0, (0, graphql_1.Args)('email')),
    tslib_1.__param(1, (0, graphql_1.Args)('password')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, String]),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(4, (0, graphql_1.Args)('license')),
    tslib_1.__metadata("design:type", Function),
...
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], AdminUser.prototype, "surname", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    (0, graphql_1.Field)(() => stream_1.Stream),
    tslib_1.__metadata("design:type", typeof (_c = typeof stream_1.Stream !== "undefined" && stream_1.Stream) === "function" ? _c : Object)
], Upload.prototype, "createReadStream", void 0);
Upload = tslib_1.__decorate([
    (0, graphql_1.InputType)()
], Upload);
exports.Upload = Upload;
let AdminUserReturn = class AdminUserReturn {
};
tslib_1.__decorate([
    (0, graphql_1.Field)(() => graphql_1.ID),
    tslib_1.__metadata("design:type", String)
], AdminUserReturn.prototype, "id", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], AdminUserReturn.prototype, "email", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], AdminUserReturn.prototype, "name", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], AdminUserReturn.prototype, "surname", void 0);
AdminUserReturn = tslib_1.__decorate([
    (0, graphql_1.ObjectType)()
], AdminUserReturn);
exports.AdminUserReturn = AdminUserReturn;
let User = class User {
};
tslib_1.__decorate([
    (0, graphql_1.Field)(() => graphql_1.ID),
...
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], DriverInput.prototype, "license", void 0);
...
let AuthRepository = class AuthRepository {
    ...
    adminLogin(email, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const user = yield this.prisma.adminUser.findUnique({
                where: {
                    email,
                },
            });
...
let AuthService = class AuthService {
    ...
    adminLogin(email, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.queryBus.execute(new auth_query_query_1.AdminLoginQuery(email, password));
        });
    }
    findTopUsers() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    registerDriver(ID, licensePlate, carModel, userId, license) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.commandBus.execute(new auth_command_command_1.DriverRegisterCommand(userId, licensePlate, carModel, ID, license));
        });
    }
    verifyEmail(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    updateUserImage(id, image) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.commandBus.execute(new auth_command_command_1.UpdateUserImageCommand(id, image));
        });
    }
    resetPassword(email, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ResetPasswordHandler = exports.UpdateUserImageHandler = exports.UserUpdateHandler = exports.UserVerifyHandler = exports.DriverRegisterHandler = exports.UserRegisterHandler = void 0;
const tslib_1 = __webpack_require__("tslib");
const repository_1 = __webpack_require__("./libs/api/authentication/repository/data-access/src/index.ts");
const cqrs_1 = __webpack_require__("@nestjs/cqrs");
const auth_command_command_1 = __webpack_require__("./libs/api/authentication/service/feature/src/lib/commands/auth-command.command.ts");
...
let UpdateUserImageHandler = class UpdateUserImageHandler {
    constructor(authRepository) {
        this.authRepository = authRepository;
    }
    execute(command) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.authRepository.updateUserImage(command.id, command.image);
        });
    }
};
UpdateUserImageHandler = tslib_1.__decorate([
    (0, cqrs_1.CommandHandler)(auth_command_command_1.UpdateUserImageCommand),
...
exports.UpdateUserImageHandler = UpdateUserImageHandler;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UpdateUserImageCommand = exports.ResetPasswordCommand = exports.UserUpdateCommand = exports.UserVerifyCommand = exports.DriverRegisterCommand = exports.UserRegisterCommand = void 0;
...
class DriverRegisterCommand {
    constructor(ID, licensePlate, carModel, userId, license) {
        this.ID = ID;
...
exports.UpdateUserImageCommand = UpdateUserImageCommand;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FindTopUsersHandler = exports.FindAllUsersHandler = exports.FindTopUniversitiesHandler = exports.FindRecentUsersHandler = exports.FindTotalDriversHandler = exports.FindTotalUsersHandler = exports.ForgotPasswordHandler = exports.FindUserByIdHandler = exports.AdminLoginHandler = exports.UserLoginHandler = void 0;
const tslib_1 = __webpack_require__("tslib");
const repository_1 = __webpack_require__("./libs/api/authentication/repository/data-access/src/index.ts");
const cqrs_1 = __webpack_require__("@nestjs/cqrs");
const auth_query_query_1 = __webpack_require__("./libs/api/authentication/service/feature/src/lib/queries/auth-query.query.ts");
...
let AdminLoginHandler = class AdminLoginHandler {
    ...
    execute(query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.authRepository.adminLogin(query.email, query.password);
        });
    }
};
AdminLoginHandler = tslib_1.__decorate([
    (0, cqrs_1.QueryHandler)(auth_query_query_1.AdminLoginQuery),
    tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof repository_1.AuthRepository !== "undefined" && repository_1.AuthRepository) === "function" ? _b : Object])
], AdminLoginHandler);
...
FindTopUsersHandler = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_k = typeof repository_1.AuthRepository !== "undefined" && repository_1.AuthRepository) === "function" ? _k : Object])
], FindTopUsersHandler);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FindTopUsersQuery = exports.FindAllUsersQuery = exports.FindTopUniversitiesQuery = exports.FindRecentUsersQuery = exports.FindTotalDriversQuery = exports.FindTotalUsersQuery = exports.ForgotPasswordQuery = exports.FindUserByIdQuery = exports.AdminLoginQuery = exports.UserLoginQuery = void 0;
...
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], Chat.prototype, "profilePic", void 0);
...
let MessageRepository = class MessageRepository {
    ...
    createMessage(message) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const messageObj = yield this.prisma.message.create({
                data: {
            ...
            const sender = yield this.prisma.user.findUnique({
                where: {
                    id: message.senderId,
                },
            });
...
TripsModule = tslib_1.__decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            service_1.DeleteMessageNotificationsHandler,
            service_1.FindByDriverForDashboardHandler,
            service_1.DeleteBookingRequestNotificationHandler,
            service_1.FindTripsForMonthHandler,
            service_1.FindBookingsByUserHandler,
            service_1.FindUpcomingTripsHandler,
            service_1.FindTripByBookingHandler,
            ...
            service_1.DeleteBookingAcceptedNotificationHandler,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TripsResolver = exports.calcCrow = void 0;
const tslib_1 = __webpack_require__("tslib");
const entities_1 = __webpack_require__("./libs/api/authentication/api/shared/entities/data-access/src/index.ts");
const entities_2 = __webpack_require__("./libs/api/trips/api/shared/entities/data-access/src/index.ts");
const service_1 = __webpack_require__("./libs/api/trips/service/feature/src/index.ts");
...
let TripsResolver = class TripsResolver {
    ...
    deleteMessageNotifications(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsService.deleteMessageNotifications(userId);
        });
    }
    deleteBookingRequestNotification(userId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsService.deleteBookingRequestNotification(userId, entity);
        });
    }
    deleteBookingAcceptedNotification(userId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsService.deleteBookingAcceptedNotification(userId, entity);
        });
    }
    /**
     ...
     * @returns {Promise<Trip[]>}
     */
    findByDriverForDashboard(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsService.findByDriverForDashboard(id);
        });
    }
    /**
    ...
    findTripByBooking(bookingId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsService.findTripByBooking(bookingId);
        });
    }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (trips.length !== 0) {
                trips.map((trip) => {
                    ...
                    // }
                    if ((0, exports.calcCrow)(Number(trip.coordinates[0].latitude), Number(trip.coordinates[0].longitude), Number(startLatitude), Number(startLongitude)) <= 5 ||
                        (0, exports.calcCrow)(Number(trip.coordinates[1].latitude), Number(trip.coordinates[1].longitude), Number(destinationLatitude), Number(destinationLongitude)) <= 5) {
                        searchResults.push(trip);
                    }
                });
            }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", typeof (_l = typeof Promise !== "undefined" && Promise) === "function" ? _l : Object)
], TripsResolver.prototype, "deleteMessageNotifications", null);
tslib_1.__decorate([
    (0, graphql_1.Mutation)(() => String),
    tslib_1.__param(0, (0, graphql_1.Args)('userId')),
    tslib_1.__param(1, (0, graphql_1.Args)('entity')),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, String]),
    tslib_1.__metadata("design:returntype", typeof (_m = typeof Promise !== "undefined" && Promise) === "function" ? _m : Object)
], TripsResolver.prototype, "deleteBookingRequestNotification", null);
tslib_1.__decorate([
    (0, graphql_1.Mutation)(() => String),
    tslib_1.__param(0, (0, graphql_1.Args)('userId')),
    tslib_1.__param(1, (0, graphql_1.Args)('entity')),
    ...
    tslib_1.__metadata("design:paramtypes", [String, String]),
    tslib_1.__metadata("design:returntype", typeof (_o = typeof Promise !== "undefined" && Promise) === "function" ? _o : Object)
], TripsResolver.prototype, "deleteBookingAcceptedNotification", null);
tslib_1.__decorate([
    (0, graphql_1.Query)(() => Number),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", typeof (_v = typeof Promise !== "undefined" && Promise) === "function" ? _v : Object)
], TripsResolver.prototype, "findByDriverForDashboard", null);
tslib_1.__decorate([
    (0, graphql_1.Query)(() => [entities_2.Trip]),
    tslib_1.__param(0, (0, graphql_1.Args)('id')),
    tslib_1.__metadata("design:type", Function),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ReviewsStatusUpdate = exports.TripStatusUpdate = exports.AcceptTripRequestUpdate = exports.TripsUpdate = exports.TripsInput = exports.TripByMonth = exports.Trip = exports.BookingRequest = exports.Notification = void 0;
const tslib_1 = __webpack_require__("tslib");
const graphql_1 = __webpack_require__("@nestjs/graphql");
const entities_1 = __webpack_require__("./libs/api/authentication/api/shared/entities/data-access/src/index.ts");
const booking_entity_entity_1 = __webpack_require__("./libs/api/trips/api/shared/entities/data-access/src/lib/booking-entity.entity.ts");
...
tslib_1.__decorate([
    (0, graphql_1.Field)(() => graphql_1.ID),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "tripId", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "bookingId", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "passengerId", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(() => Date),
    tslib_1.__metadata("design:type", typeof (_d = typeof Date !== "undefined" && Date) === "function" ? _d : Object)
], BookingRequest.prototype, "tripDate", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "passengerName", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "passengerPic", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int),
    tslib_1.__metadata("design:type", Number)
], BookingRequest.prototype, "passengerRating", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "startAddress", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "endAddress", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "startLat", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "startLong", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "endLat", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "endLong", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "pickupAddress", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "pickupLat", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    tslib_1.__metadata("design:type", String)
], BookingRequest.prototype, "pickupLong", void 0);
...
tslib_1.__decorate([
    (0, graphql_1.Field)(() => entities_1.User),
    tslib_1.__metadata("design:type", typeof (_g = typeof entities_1.User !== "undefined" && entities_1.User) === "function" ? _g : Object)
...
let TripsRepository = class TripsRepository {
    ...
    deleteAllMessageNotifications(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.prisma.notification.deleteMany({
                where: {
                    AND: [
                        {
                            userId: userId,
    ...
    deleteRequestNotification(userId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.prisma.notification.deleteMany({
                where: {
                    AND: [
    ...
    deleteAcceptedNotification(userId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.prisma.notification.deleteMany({
                where: {
                    AND: [
    ...
    findByDriverForDashboard(driverId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prisma.trip.findMany({
                where: {
                    driverId: driverId,
    ...
    findTripByBooking(bookingId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (trips.length !== 0) {
                const booking = yield this.prisma.booking.findUnique({
                    where: {
                        bookingId: bookingId,
                    },
                });
                const tripLocation = yield this.prisma.location.findMany({
                    where: {
                ...
                const pickup = yield this.prisma.pickupLocation.findUnique({
                    where: {
                        bookingId: bookingId,
                    },
                });
                const bookingRequest = new entities_1.BookingRequest();
    ...
    bookTrip(tripId, passengerId, seatsBooked, status, price, address, longitude, latitude) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const bookingObj = yield this.prisma.booking.create({
                data: {
                    trip: {
                        connect: { tripId },
                    },
...
let DeleteMessageNotificationsHandler = class DeleteMessageNotificationsHandler {
    constructor(tripsRepository) {
        this.tripsRepository = tripsRepository;
    }
    execute(command) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.tripsRepository.deleteAllMessageNotifications(userId);
        });
    }
};
DeleteMessageNotificationsHandler = tslib_1.__decorate([
    (0, cqrs_1.CommandHandler)(trips_command_command_1.DeleteMessageNotificationsCommand),
...
exports.DeleteMessageNotificationsHandler = DeleteMessageNotificationsHandler;
let DeleteBookingRequestNotificationHandler = class DeleteBookingRequestNotificationHandler {
    constructor(tripsRepository) {
        this.tripsRepository = tripsRepository;
    }
    execute(command) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.tripsRepository.deleteRequestNotification(userId, entity);
        });
    }
};
DeleteBookingRequestNotificationHandler = tslib_1.__decorate([
    (0, cqrs_1.CommandHandler)(trips_command_command_1.DeleteBookingRequestNotificationCommand),
...
exports.DeleteBookingRequestNotificationHandler = DeleteBookingRequestNotificationHandler;
let DeleteBookingAcceptedNotificationHandler = class DeleteBookingAcceptedNotificationHandler {
    constructor(tripsRepository) {
        this.tripsRepository = tripsRepository;
    }
    execute(command) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { userId, entity } = command;
            return yield this.tripsRepository.deleteAcceptedNotification(userId, entity);
        });
    }
};
DeleteBookingAcceptedNotificationHandler = tslib_1.__decorate([
    (0, cqrs_1.CommandHandler)(trips_command_command_1.DeleteBookingAcceptedNotificationCommand),
...
exports.DeleteBookingAcceptedNotificationHandler = DeleteBookingAcceptedNotificationHandler;
...
class BookTripCommand {
    constructor(tripId, passengerId, seatsBooked, status, price, address, latitude, longitude) {
        this.tripId = tripId;
...
class DeleteMessageNotificationsCommand {
    constructor(userId) {
        this.userId = userId;
    }
}
exports.DeleteMessageNotificationsCommand = DeleteMessageNotificationsCommand;
class DeleteBookingRequestNotificationCommand {
    constructor(userId, entity) {
        this.userId = userId;
        this.entity = entity;
    }
}
exports.DeleteBookingRequestNotificationCommand = DeleteBookingRequestNotificationCommand;
class DeleteBookingAcceptedNotificationCommand {
    constructor(userId, entity) {
        this.userId = userId;
        this.entity = entity;
    }
}
exports.DeleteBookingAcceptedNotificationCommand = DeleteBookingAcceptedNotificationCommand;
...
let FindByDriverForDashboardHandler = class FindByDriverForDashboardHandler {
    constructor(tripsRepository) {
        this.tripsRepository = tripsRepository;
    }
    execute(query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsRepository.findByDriverForDashboard(query.driverId);
        });
    }
};
FindByDriverForDashboardHandler = tslib_1.__decorate([
    (0, cqrs_1.QueryHandler)(trips_query_query_1.FindByDriverForDashboardQuery),
    tslib_1.__metadata("design:paramtypes", [typeof (_c = typeof repository_1.TripsRepository !== "undefined" && repository_1.TripsRepository) === "function" ? _c : Object])
], FindByDriverForDashboardHandler);
exports.FindByDriverForDashboardHandler = FindByDriverForDashboardHandler;
...
let FindTripByBookingHandler = class FindTripByBookingHandler {
    constructor(tripsRepository) {
        this.tripsRepository = tripsRepository;
    }
    execute(query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.tripsRepository.findTripByBooking(query.bookingId);
        });
    }
};
FindTripByBookingHandler = tslib_1.__decorate([
    (0, cqrs_1.QueryHandler)(trips_query_query_1.FindTripByBookingQuery),
    tslib_1.__metadata("design:paramtypes", [typeof (_l = typeof repository_1.TripsRepository !== "undefined" && repository_1.TripsRepository) === "function" ? _l : Object])
], FindTripByBookingHandler);
exports.FindTripByBookingHandler = FindTripByBookingHandler;
...
FindALlNotificationsHandler = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_x = typeof repository_1.TripsRepository !== "undefined" && repository_1.TripsRepository) === "function" ? _x : Object])
...
FindBookingByIdHandler = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_y = typeof repository_1.TripsRepository !== "undefined" && repository_1.TripsRepository) === "function" ? _y : Object])
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FindTripByBookingQuery = exports.FindBookingByIdQuery = exports.FindAllNotificationsQuery = exports.FindBookingsByUserQuery = exports.FindTripsByMonthQuery = exports.FindBookingsForMonthQuery = exports.FindTripsForMonthQuery = exports.FindUpcomingTripsQuery = exports.FindAllTripRequestsQuery = exports.SearchTripsQuery = exports.FindTripByIdQuery = exports.FindCoordinatesByTripQuery = exports.FindBookingByTripAndUserIdQuery = exports.FindBookingByTripQuery = exports.findByDriverReviewsQuery = exports.findAllPassengersQuery = exports.findByPassengerReviewsQuery = exports.findByRequestedTripsQuery = exports.findByConfirmedTripsQuery = exports.FindByPassengerQuery = exports.FindByDriverForDashboardQuery = exports.FindByDriverQuery = exports.FindAllQuery = void 0;
class FindAllQuery {
}
...
class FindByDriverForDashboardQuery {
    constructor(driverId) {
        this.driverId = driverId;
    }
}
exports.FindByDriverForDashboardQuery = FindByDriverForDashboardQuery;
...
class FindTripByBookingQuery {
    constructor(bookingId) {
        this.bookingId = bookingId;
    }
}
exports.FindTripByBookingQuery = FindTripByBookingQuery;
...
let TripsService = class TripsService {
    ...
    deleteMessageNotifications(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.commandBus.execute(new trips_command_command_1.DeleteMessageNotificationsCommand(userId));
        });
    }
    deleteBookingRequestNotification(userId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.commandBus.execute(new trips_command_command_1.DeleteBookingRequestNotificationCommand(userId, entity));
        });
    }
    deleteBookingAcceptedNotification(userId, entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return this.commandBus.execute(new trips_command_command_1.DeleteBookingAcceptedNotificationCommand(userId, entity));
        });
    }
    findTripById(tripId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    findByDriverForDashboard(driverId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.queryBus.execute(new trips_query_query_1.FindByDriverForDashboardQuery(driverId));
        });
    }
    findByPassenger(passengerId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    findTripByBooking(bookingId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.queryBus.execute(new trips_query_query_1.FindTripByBookingQuery(bookingId));
        });
    }
    findBookingByTripAndUserId(tripID, userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
